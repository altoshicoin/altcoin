    ...
    m_network_style(networkStyle)
{
    ...
    // === outer border gutter (inserted) ===if (QWidget* cw = this->centralWidget()) {
        if (QLayout* l = cw->layout()) l->setContentsMargins(6,6,6,6);
        else cw->setContentsMargins(6,6,6,6);
    }// === end outer border gutter ===
...
void BitcoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Altcoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from clipboard..."), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Altcoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open an altcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Altcoin command-line options").arg(PACKAGE_NAME));

...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        frameMWEBFeatures->setObjectName(QString::fromUtf8("frameMWEBFeatures"));
        ...
        verticalLayoutMWEBFeatures2->setObjectName(QString::fromUtf8("verticalLayoutMWEBFeatures2"));
        ...
        verticalLayoutMWEBFeatures->setObjectName(QString::fromUtf8("verticalLayoutMWEBFeatures"));
        verticalLayoutMWEBFeatures->setContentsMargins(10, 10, -1, -1);
        horizontalLayoutMWEBFeatures1 = new QHBoxLayout();
        horizontalLayoutMWEBFeatures1->setObjectName(QString::fromUtf8("horizontalLayoutMWEBFeatures1"));
        horizontalLayoutMWEBFeatures1->setContentsMargins(-1, -1, -1, 15);
        labelMWEBFeatures = new QLabel(frameMWEBFeatures);
        labelMWEBFeatures->setObjectName(QString::fromUtf8("labelMWEBFeatures"));
        ...
        labelMWEBFeatures->setStyleSheet(QString::fromUtf8("font-weight:bold;"));
        ...
        horizontalLayoutMWEBFeatures2->setObjectName(QString::fromUtf8("horizontalLayoutMWEBFeatures2"));
        horizontalLayoutMWEBFeatures2->setContentsMargins(-1, -1, -1, 10);
        pushButtonMWEBPegIn = new QPushButton(frameMWEBFeatures);
        pushButtonMWEBPegIn->setObjectName(QString::fromUtf8("pushButtonMWEBPegIn"));
        pushButtonMWEBPegIn->setStyleSheet(QString::fromUtf8(""));
        ...
        pushButtonMWEBPegOut->setObjectName(QString::fromUtf8("pushButtonMWEBPegOut"));
        pushButtonMWEBPegOut->setStyleSheet(QString::fromUtf8(""));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelMWEBFeatures->setText(QCoreApplication::translate("SendCoinsDialog", "Advanced MWEB Features", nullptr));
        pushButtonMWEBPegIn->setText(QCoreApplication::translate("SendCoinsDialog", "Peg-In LTC", nullptr));
        pushButtonMWEBPegOut->setText(QCoreApplication::translate("SendCoinsDialog", "Peg-Out LTC", nullptr));
...
#if QT_CONFIG(tooltip)
        labelCustomFeeWarning->setToolTip(QCoreApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for litecoin transactions than the network can process.", nullptr));
#endif // QT_CONFIG(tooltip)

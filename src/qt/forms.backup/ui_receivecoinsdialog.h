...
public:
    ...
    void setupUi(QDialog *ReceiveCoinsDialog)
    {
        ...
        useMWEB->setObjectName(QString::fromUtf8("useMWEB"));
    ...
    void retranslateUi(QDialog *ReceiveCoinsDialog)
    {
...
#if QT_CONFIG(tooltip)
        label_3->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Litecoin network.", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        useMWEB->setText(QCoreApplication::translate("ReceiveCoinsDialog", "Generate MWEB address", nullptr));

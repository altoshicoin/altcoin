...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        mwebFeatures->setObjectName(QString::fromUtf8("mwebFeatures"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        mwebFeatures->setText(QCoreApplication::translate("OptionsDialog", "Enable advanced MW&EB features", nullptr));
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        mapPortUpnp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Litecoin client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Litecoin network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Litecoin network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_CONFIG(tooltip)

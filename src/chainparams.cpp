...
{
    const char* pszTimestamp = "ALTCOIN genesis 2025-10-16 - own chain, own math";
...
public:
    CMainParams() {
        ...
        assert(genesis.hashMerkleRoot == uint256S("0x4f3637f43fb675640aaf39f50ae737d42cbce2a57a6891859c38f02295846336"));
...
public:
    CTestNetParams() {
        ...
        {
    // ALTCOIN testnet genesis
    const char* pszTimestamp = "ALTCOIN testnet genesis 2025-10-16 - builders welcome";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    ...
    genesis = CreateGenesisBlock(pszTimestamp, genesisOutputScript,
                                 ...
                                 0x1e0ffff0,   // nBits
                                 1,            // nVersion
                                 (52 * COIN) + 38095238); // genesisReward (matches your 88M plan)
    }
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe068f7e6610fd4f8faafb136e7ee4bd5d97fad3fe739e67b8f61e492fa234acc"));
        assert(genesis.hashMerkleRoot == uint256S("0x2797fa6064379522d58a3db5c520e25d6c2ed165ce6e01bd4703f7aed4a8294c"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        {
    // ALTCOIN regtest genesis
    const char* pszTimestamp = "ALTCOIN regtest genesis 2025-10-16 - fast dev chain";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;

    genesis = CreateGenesisBlock(pszTimestamp, genesisOutputScript,
                                 1760636060,   // nTime
                                 0,            // nNonce
                                 0x207fffff,   // nBits (easy regtest)
                                 1,            // nVersion
                                 (52 * COIN) + 38095238); // genesisReward
    }
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2a8ae1daec96c0173915d289f9149a5fff6c906cf78270bdd60292a68b31d72e"));
        assert(genesis.hashMerkleRoot == uint256S("0x84f5faee6c50cee900f8cb3fe7c8b4d348c156544d61a43d270904d88b3852c1"));

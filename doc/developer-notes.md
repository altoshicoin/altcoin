...
- [Development guidelines](#development-guidelines)
    - [General Altcoin Core](#general-litecoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Altcoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
([`valgrind.supp`](https://github.com/altoshicoin/altcoin/blob/master/contrib/valgrind.supp))
...
To profile a running altcoind process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep altcoind` -- sleep 60
```
...
compatibility between nodes. This happened in Altcoin 0.8 (when LevelDB was

...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./altcoind -proxy=127.0.0.1:9050 -externalip=7zvj7a2imdgkdbg4f2dryd5rgtrn7upivr5eeij4cicjh65pooxeshid.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./altcoind -onion=127.0.0.1:9050 -externalip=7zvj7a2imdgkdbg4f2dryd5rgtrn7upivr5eeij4cicjh65pooxeshid.onion -discover
...
Altcoin Core automatically creates an onion service to listen on. This will positively
...
in `torrc` config file. For cookie authentication the user running altcoind must have read
...
which has the appropriate permissions. Before starting altcoind you will need to re-login
...
- Do not add anything but Altcoin Core ports to the onion service created in section 2.

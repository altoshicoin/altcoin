...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Altcoin Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Altcoin"

touch "/Users/${USER}/Library/Application Support/Altcoin/altcoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Altcoin/altcoin.conf"
```

The first time you run altcoind, it will start downloading the blockchain. This process could
